...
`}
        >
            <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center overflow-hidden text-blue-700 font-semibold 
text-lg flex-shrink-0">
            ...
            <div className="mt-4 flex items-center justify-between gap-2">
                ...
                <span
                    ...
                    className={`text-xs px-2.5 py-1 rounded-full font-medium ${statusStyle.bg} ${statusStyle.text} ${onToggleStatus ?
